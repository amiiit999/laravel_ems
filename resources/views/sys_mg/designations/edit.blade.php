                    ...
                    <div class="row">
                        <form action="{{route('designations.update',$designation->id)}}" method="POST">
                            ...
                            <i class="material-icons prefix">account_balance</i>
                                <input type="text" name="designation" id="designation" value="{{Request::old('designation') ? : $designation->emp_designation}}">
                                <label for="dept_name">Designation Name</label>
                                <span class="{{$errors->has('designation') ? 'helper-text red-text' : ''}}">{{$errors->first('designation')}}</span>
                            </div>
                            @method('PUT')
                            @csrf()
