...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">Designations Management</h4>
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">Designations List</h5>
                            ...
                            @if($designation->count())
                                @foreach($designation as $designations)
                                    <tr>
                                        ...
                                        <td>{{$designations->emp_designation}}</td>
                                        <td>{{$designations->created_at}}</td>
                                        <td>{{$designations->updated_at}}</td>
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                    {{-- 
                                                     ...
                                                     --}}
                                                    <a href="{{route('designations.edit',$designations->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    {{-- 
                ...
                <div class="center" id="pagination">
                  {{$designation->links('vendor.pagination.default',['paginator' => $designation])}}
                </div>
            </div>
        </div>
        <!-- Card END -->
