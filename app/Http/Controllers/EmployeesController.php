...
class EmployeesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.index',['punching'=>$punching]);
    }
    ...
    public function create()
    {
        ...
        $designation = Designation::orderBy('emp_designation','asc')->get();
    ...
    public function show($id)
    {
        ...
        $punchings= Punching::where('employee_id','=',$id)->get();
         return view('employee.show',['punchings'=>$punchings,'employee'=>$employee]);
    ...
    public function handleImageUpload(Request $request){
           ...
           if(Input::hasFile('picture')){
            ...
            $file->move(base_path().'/image_gl/employees/',$file->getClientOriginalName());
            $url=URL::to("/").'/image_gl/employees/'.$file->getClientOriginalName();
         }
