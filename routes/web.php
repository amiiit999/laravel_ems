...
Route::get('/attendence_create/{id}','AttendenceController@attcreate');
Route::post('attendence_store/{id}','AttendenceController@attstore');
...
Route::post('leavesd/{id}','LeavesController@leavestore');
Route::get('add_leaves/{id}','LeavesController@addleaves');
Route::get('leavesedit/{id}','LeavesController@leavesedit');
Route::post('updateleaves/{id}','LeavesController@updateleaves');
Route::post('punch_update/{id}','AttendenceController@punching_update');
