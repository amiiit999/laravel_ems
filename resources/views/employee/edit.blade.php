                    ...
                    <form action="{{route('employees.update',$employee->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl8 offset-xl2">
                                <i class="material-icons prefix">security
</i>
                                <input type="text" name="password" id="password" value="{{old('email') ? : $employee->password}}">
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="designation">
                                    ...
                                    @foreach($designation as $designations)
                                        <option value="{{$designations->id}}" {{ old('designation') ? 'selected' : '' }} {{ $employee->empDesignation==$designations ? 'selected' : '' }} >{{$designations->emp_designation}}</option>
                                    @endforeach
                                </select>
