...
@section('content')
    ...
    <div>
        <div class="row white-text">
            ...
            <a href="/attendence" class="white-text">
                <div class="mx-20 card-panel orange col s8 offset-s2 m4 l4 xl2">
                    <div class="row">
                        <div class="col s7 xl7">
                            <i class="material-icons medium white-text pt-5">fingerprint</i>
                            <h6 class="no-padding txt-md">Punching</h6>
                        </div>
                        <div class="col s5 xl5">
            ...
            <a href="/salaries" class="white-text hide-on-small-only">
                <div class="card-panel green col s8 offset-s2 m4 l4 xl2 mx-20">
                    <div class="row">
                        <div class="col s7 xl7">
                            <i class="material-icons medium white-text pt-5">account_balance_wallet</i>
